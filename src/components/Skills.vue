                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="progress-container progress-primary">
                              <span class="progress-badge" id="badge-html">
                                  <i class="fab fa-html5 mr-2"></i>
                                  <b>
                                      <a class="text-muted" href="https://fr.wikipedia.org/wiki/HTML5" target="_blank">HTML</a>
                                  </b>
                              </span>
                                <div class="progress">
                        ...
                        <div class="col-md-6">
                            <div class="progress-container progress-primary">
                                <span id="badge-css" class="progress-badge">
                                    ...
                                    <b>
                                        <a class="text-muted" href="https://fr.wikipedia.org/wiki/Feuilles_de_style_en_cascade" target="_blank">CSS</a>
                                    </b>
                                </span>
                                <div class="progress">
                        ...
                        <div class="col-md-6">
                            <div class="progress-container progress-primary">
                                <span id="badge-js" class="progress-badge">
                                    ...
                                    <b>
                                        <a class="text-muted" href="https://developer.mozilla.org/fr/docs/Web/JavaScript" target="_blank">JavaScript</a>
                                    </b>
                                </span>
                                <div class="progress">
                        ...
                        <div class="col-md-6">
                            <div class="progress-container progress-primary">
                                <span id="badge-vuejs" class="progress-badge">
                                    ...
                                    <b>
                                        <a class="text-muted" href="https://vuejs.org/" target="_blank">VueJS</a>
                                    </b>
                                </span>
                                <div class="progress">
                        ...
                        <div class="col-md-6">
                            <div class="progress-container progress-primary">
                                <span id="badge-php" class="progress-badge">
                                    ...
                                    <b>
                                        <a class="text-muted" href="https://fr.wikipedia.org/wiki/PHP" target="_blank">PHP</a>
                                    </b>
                                </span>
                                <div class="progress">
                        ...
                        <div class="col-md-6">
                            <div class="progress-container progress-primary">
                                <span id="badge-codeigniter" class="progress-badge">
                                    ...
                                    <b>
                                        <a class="text-muted" href="https://codeigniter.com/" target="_blank">CodeIgniter</a>
                                    </b>
                                </span>
                                <div class="progress">
                        ...
                        <div class="col-md-6">
                            <div class="progress-container progress-primary">
                                <span id="badge-mysql" class="progress-badge">
                                    ...
                                    <b>
                                        <a class="text-muted" href="https://www.mysql.com/fr/" target="_blank">MYSQL</a>
                                    </b>
                                </span>
                                <div class="progress">
