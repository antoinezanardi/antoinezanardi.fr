...
@my-education
  ...
  Feature: 🎓️ Home Page - My Education Section
    ...
    Scenario: 🎓️ My Education Section displays all diplomas
      ...
      And the nested region with exact name "Google Associate Cloud Engineer (ACE) obtenu en 2022" under the region with name "1 - Google Associate Cloud Engineer (ACE)" should be visible
      ...
      And the nested region with exact name "Certified Kubernetes Application Developer (CKAD) obtenu en 2022" under the region with name "2 - Certified Kubernetes Application Developer (CKAD)" should be visible
      ...
      And the nested region with exact name "Master en Informatique - Titre d'Expert obtenu en 2019" under the region with name "3 - Master en Informatique - Titre d'Expert" should be visible
      ...
      And the nested region with exact name "Certificat en Technologies de l'Information (Double diplôme) obtenu en 2018" under the region with name "4 - Certificat en Technologies de l'Information (Double diplôme)" should be visible
      ...
      And the nested region with exact name "Baccalauréat Scientifique obtenu en 2014" under the region with name "5 - Baccalauréat Scientifique" should be visible
